    ...
    <div>
      <section className="border-b border-[#DDE8F0] bg-[#F7FAFD] py-16">
        <div className="mx-auto max-w-[1240px] px-4 sm:px-6">
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#5CAFD6]">Библиотека</p>
          <h1 className="mt-2 text-4xl font-black text-[#0D1C2E] lg:text-5xl">База знаний</h1>
          <p className="mt-3 max-w-2xl text-lg text-[#4B6075]">
